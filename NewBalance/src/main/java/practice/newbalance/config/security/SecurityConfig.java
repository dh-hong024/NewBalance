    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/admin","/admin-page","/notice/notice-form","/notice/notice-detail", "/notice/edit-form","/admin/faqs").hasRole("ADMIN") //해당 경로는 인증이 필요 ROLE이 ADMIN이 포함된 경우에만 인증 가능
